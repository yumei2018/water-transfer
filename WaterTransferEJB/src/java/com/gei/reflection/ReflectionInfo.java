...
public class ReflectionInfo {
  ...
  //<editor-fold defaultstate="collapsed" desc="Static Classs MapEntryClasses ">
  /**
  ...
  public static <TKey, TValue> MapEntryClasses<TKey,TValue> 
    ...
    MapEntryClasses<TKey,TValue> result = new MapEntryClasses<TKey,TValue>();
    try {
      if (map == null) {
  ...
  public static <T> List<Class<?>> getTypeArguments(Class<T> baseClass,
    ...
    List<Class<?>> typeArgsAsClasses = new ArrayList<Class<?>>();
