...
CREATE TABLE WT_TRANS (
  ...
  ,PRO_ACR_IDLE_IND NUMBER(1,0) DEFAULT 0 NOT NULL
  ,ACT_FALL_ACR NUMBER(32,0)
  ,ACT_FALL_ACR_IND NUMBER(1,0) DEFAULT 0 NOT NULL 
  ,RES_RE_OP_IND NUMBER(1,0) DEFAULT 0 NOT NULL 
  ,CONS_WATER_IND NUMBER(1,0) DEFAULT 0 NOT NULL
  ,WELL_USE_NUM NUMBER(16,0)
  ,WELL_USE_NUM_IND NUMBER(1,0) DEFAULT 0 NOT NULL
...
CREATE TABLE WT_TRANS_TYPE (
  ...
  ,PRIMARY KEY (WT_TRANS_ID, WT_FU_TYPE_ID)
);
/
