<%--
    ...
    Created on : Jul 13, 2015, 1:46:47 PM
    Author     : pheng
--%>
...
<div id="report_review_ct">
  ...
  <div class="title">
    ...
    <div class="header">Seller/Buyer(s) Information</div>
    <div class="sellerCt">
    <c:forEach items="${proposal.wtSellerCollection}" var="seller">
      <span>Seller's Agency: <b>${seller.agencyFullName}--${seller.agencyType}</b></span>
      <table>
        <thead>
          <tr>
            <th>First Name</th>
  ...
  <div class="buyerCt">
    <c:forEach items="${proposal.wtBuyerCollection}" var="buyer">
      <span>Buyer's Agency: <b>${buyer.wtAgency.agencyFullName}--${buyer.wtAgency.agencyType}--${buyer.sharePercent}%</b></span>
      <table>
        <thead>
          <tr>
            <th>First Name</th>
