...
<div class="cropCt section ${ci_empty}" section="ciInfo">
  <div class="section">
    <h1>Crop Idling and Crop Shifting Information</h1>
    <div>
      <span>Water Transfer Amount (acre-feet): </span><span class="highlight"><fmt:formatNumber type="number" value="${proposal.wtCropIdling.waterTransQua}"/></span>
    </div>
<!--    <div>
      <span>Proposed Transfer Acreage by Crop Idling (Acres):</span><span class="highlight"><fmt:formatNumber type="number" value="${proposal.wtCropIdling.proTransferByCI}"/></span>
    </div>
    <div>
      <span>Proposed Transfer Acreage by Crop Shift (Acres):</span><span class="highlight"><fmt:formatNumber type="number" value="${proposal.wtCropIdling.proTransferByCS}"/></b></span>
    </div>-->
    <div>
      <span>Total Proposed Acreage: </span><span class="highlight"><fmt:formatNumber type="number" value="${proposal.wtCropIdling.totalTransferAcr}"/></span>
    </div>
    <div>
      <span>Current-year Farm Service Agency (Acres): </span><span class="highlight"><fmt:formatNumber type="number" value="${proposal.wtCropIdling.currentFsAgency}"/></span>
    </div>
    <div>
  ...
  <div class="section">
   ...
   <table>
      ...
      <c:forEach var="ciCroptype" items="${proposal.wtCropIdling.croptypeCollection}">
        <tr>
          <td class="highlight" style="text-align: center;">${ciCroptype.cropWithoutTransfer}</td>
          <td class="highlight" style="text-align: center;">${ciCroptype.cropWithTransfer}</td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${ciCroptype.proTransferTotal}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${ciCroptype.cropEtaw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${ciCroptype.waterTransferAmount}"/></td>
        </tr>
      </c:forEach>  
      </tbody>
   </table>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${mayEtaw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${juneEtaw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${julyEtaw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${augustEtaw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${septemberEtaw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${totalEtaw}"/></td>
        </tr>
        <tr>
          <td style="text-align: center;">Transfer Water (acre-feet)</td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${mayTw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${juneTw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${julyTw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${augustTw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${septemberTw}"/></td>
          <td class="highlight" style="text-align: center;"><fmt:formatNumber type="number" value="${totalTw}"/></td>
        </tr>
      </tbody>
    </table>
  </div>
