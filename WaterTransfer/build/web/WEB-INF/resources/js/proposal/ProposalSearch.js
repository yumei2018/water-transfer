...
//    var url = window.SERVER_ROOT + "/proposalservice/getpubliclist";
    var url = window.SERVER_ROOT + "/proposal/searchResult?data="+JSON.stringify(data);
//    var url = window.SERVER_ROOT + "/proposalservice/getpubliclist";
...
//            return html; 
        ...
        , {render: function (data, display, row, setting) {
            ...
            var html = "<a href='' onclick='window.proposalSearch.expandProposalDetail("+row.wtTransId+",this);return false;'>Details</a>";            
