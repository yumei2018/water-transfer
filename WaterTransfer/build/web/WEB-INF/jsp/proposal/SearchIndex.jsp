...
,${pageContext.request.contextPath}/resources/js/proposal/ProposalSearch.js
</c:set>
      ...
      <tr>
        <th colspan='2'>
          <input class="proposal_btn" 
                 ...
                 value="Search" 
                 style="width:100px;" 
                 onclick="window.proposalSearch.initSearch(this);"/>
          <input class="proposal_btn" 
                 type="button" 
                 id="resetSearch_btn" 
                 value="Reset Search" 
                 style="width:100px;" 
                 onclick="window.proposalSearch.resetSearch(this);"/>
        </th>
      </tr>
    </tbody>
  </table>
...
<!--  <div class="entries_filter">
  ...
  <div style="width: 100%;">
    <a class="linkLine" id="detailCSV" onclick="window.proposalSearch.initPrintCSV(this);return false;">Export CSV with details</a>
    <a class="linkLine" id="simpleCSV" onclick="window.proposalSearch.initPrintCSV(this);return false;">Export CSV </a>
  </div>
</div>
...
<script type="text/javascript">
  $(document).ready(function () {
    window.proposalSearch = new ProposalSearch();
  });
</script>